...
namespace BananaParty.Arch.TestUtilities.Polyfills
{
    ...
    /// </summary>
    public sealed class TimedWaitUntil : CustomYieldInstruction
    {
        ...
        public TimedWaitUntil(Func<bool> predicate, TimeSpan timeout, Action onTimeout, TimeoutMode timeoutMode = TimeoutMode.Realtime)
        {
